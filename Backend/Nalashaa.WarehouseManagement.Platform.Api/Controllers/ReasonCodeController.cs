...
public class ReasonCodeController : ControllerBase
{
    ...
    public ReasonCodeController(IReasonCodeService service) => _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> Save(ReasonCode entity) => Ok(await _service.SaveAsync(entity));
